...
const Home = () => {
    ...
    return (
        <section ref={scrollAnimScope} className="min-h-screen flex flex-col items-center justify-center bg-transparent">
            ...
            <div className="relative min-h-screen w-full bg-transparent flex flex-col items-center pt-20 pb-24 font-sans">
                ...
                >
                    <h1 className="text-[color:var(--app-fg)] text-2xl md:text-3xl font-light">
                        ...
                        <span className="text-[color:var(--app-accent)] font-semibold">cross-functional</span> team
                    </h1>
                ...
                <div className="flex flex-wrap justify-center gap-4 sm:gap-6 z-20 mb-16 sm:mb-20">
                    {topIcons.map((item, index) => {
                        ...
                        return (
                            <div
                                key={item.name}
                                className="top-tech-icon w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[color:var(--app-surface)] border border-[color:var(--app-border)] flex items-center justify-center shadow-[0_10px_25px_rgba(0,0,0,0.35)]"
                            >
                ...
                >
                    ...
                    {topIcons.map((_, index) => {
                        const centerX = 500;
                        const spacing = 110;
                        const startX = centerX + (index - (topIcons.length - 1) / 2) * spacing;
                ...
                <div className="relative flex justify-center items-center w-full h-[420px] sm:h-[480px] lg:h-[540px] mt-auto [perspective:1200px]">
                    ...
                    >
                        ...
                        <div className="rounded-full absolute border border-transparent blur-[6px]
                        w-[520px] h-[520px] sm:w-[680px] sm:h-[680px] lg:w-[820px] lg:h-[820px]" />
                        ...
                        <div className="rounded-full absolute border border-transparent blur-[5px]
                        w-[360px] h-[360px] sm:w-[440px] sm:h-[440px] lg:w-[520px] lg:h-[520px]" />
